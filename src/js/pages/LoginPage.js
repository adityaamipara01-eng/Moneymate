...
export function renderLoginPage(container, state) {
            ...
            <div class="card animate-fade-in" style="width: 100%; max-width: 420px; padding: 2.5rem; box-shadow: var(--shadow-lg), var(--shadow-glow); border-color: hsl(var(--surface-border) / 0.8);">
                ...
                <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem; margin-bottom: 2rem; text-align: center;">
                    <a href="#" id="auth-logo-link" style="display: flex; align-items: center; gap: 0.5rem;">
                        <div style="width: 38px; height: 38px; background: linear-gradient(135deg, hsl(var(--primary)), hsl(var(--primary-hover))); border-radius: var(--border-radius-sm); display: flex; align-items: center; justify-content: center; color: white;">
                            <i data-lucide="wallet" style="width: 20px; height: 20px;"></i>
                        </div>
                        <span style="font-family: var(--font-heading); font-weight: 700; font-size: 1.35rem; letter-spacing: -0.5px;">MoneyMate</span>
                    </a>
                ...
                <form id="login-form" onsubmit="return false;" style="display: flex; flex-direction: column; gap: 1.25rem;">
                    <div class="form-group">
                        ...
                        <input type="email" id="login-email" class="form-input" placeholder="name@example.com" required value="aditya.raj@example.com">
                    </div>
                    ...
                    <div class="form-group" style="position: relative;">
                        ...
                        <div style="position: relative; width: 100%;">
                            <input type="password" id="login-password" class="form-input" style="padding-right: 2.75rem;" placeholder="Enter password" required value="password123">
    ...
    loginForm.onsubmit = (e) => {
        ...
        // Simulating matching demo user data
        setState({
