...
export function renderDashboard(container, state) {
        ...
        <div class="animate-fade-in" style="display:flex; flex-direction:column; gap:2rem; width:100%;">
            ...
            <div class="app-header">
                <div class="header-title-section">
                    ...
                    <p>${dateStr} • MoneyMate System Diagnostics</p>
                </div>
    ...
    const datasets = [
        { label: 'Income', data: [65000, 58000, 72000, 68000, 88000, totalIncome], color: 'hsl(var(--success))' },
        { label: 'Expense', data: [32000, 44000, 39000, 41000, 37000, totalExpense], color: 'hsl(var(--danger))' }
    ];
