...
import { setState, logout } from '../app.js';
                    ...
                    <div style="flex:1; min-width:220px; display:flex; flex-direction:column; gap:0.5rem;">
                        <div>
                            <div style="display:flex; align-items:center; gap:0.75rem; flex-wrap:wrap;">
                                <h2 style="font-size:1.6rem; font-weight:800; font-family:var(--font-heading); color:hsl(var(--text-primary));">${user.name || 'Your Name'}</h2>
                    ...
                    <form id="profile-info-form" onsubmit="return false;" style="display:flex; flex-direction:column; gap:1.25rem;">
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="prof-name" class="form-input" placeholder="Full Name" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="prof-email">Email Address</label>
                                <input type="email" id="prof-email" class="form-input" placeholder="Email Address" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="prof-phone">Phone Number</label>
                            <input type="text" id="prof-phone" class="form-input" placeholder="Phone Number (e.g. +91 98765 43210)" required>
                        </div>
                ...
                <div class="card">
                    ...
                    <form id="profile-upi-form" onsubmit="return false;" style="display:flex; flex-direction:column; gap:1.25rem;">
                        <div class="form-group">
                            ...
                            <input type="text" id="prof-upi-id" class="form-input" placeholder="Default UPI VPA ID (e.g. yourname@okaxis)" required>
                        </div>
...
<option value="£">British Pound (GBP £)</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="prof-budget" class="form-input" placeholder="Monthly Budget Limit" required min="1000">
                            </div>
                        </div>
    ...
    if (logoutBtn) {
        logoutBtn.onclick = () => {
            if (confirm('Log out from Kharcha? This will clear your current local session data.')) {
                logout();
            }
        };
    }
